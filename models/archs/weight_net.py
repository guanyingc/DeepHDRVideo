"""
Network architecture for weight net
"""
import torch
...
class Upsample(nn.Module):
    def __init__(self, c_in, c_out, use_bn=True, afunc='LReLU'):
        ...
        self.layers = torch.nn.Sequential(
            ...
            nutils.deconv_layer(c_in//2,  c_in//2, use_bn=use_bn, afunc=afunc),
            nutils.conv_layer(c_in//2, c_in//2, k=3, stride=1, pad=1, afunc=afunc, use_bn=use_bn),
            nutils.deconv_layer(c_in//2, last_c, use_bn=use_bn, afunc=afunc),
